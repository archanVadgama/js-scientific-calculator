...
let calculator = new Calculator(60,1);
// console.log(calculator.add());
console.log(calculator);
console.log('before');
console.log(new calculator.constructor(60).sinR()+' value is');
console.log('after');
console.log(calculator.sinR());
console.log(calculator.sinD());
console.log(calculator.log10());
